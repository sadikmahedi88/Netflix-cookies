...
def create_base_folders():
    ...
    if not os.path.exists(proxy_file):
        with open(proxy_file, "w", encoding="utf-8") as f:
            f.write("# dev : https://t.me/murphython")
            f.write("channel : https://t.me/+00Uzen6uu10zYTZk")
...
def build_telegram_full_message(config, info, is_subscribed, output_filename, nftoken_data=None, use_emojis=True):
    ...
    if payment.upper() == "CC" and card and card != "N/A":
        ...
        card_display = ""
    lines = [
    f"<b>✨ {plan.upper()} ACCOUNT ACCESS</b>",
    "━━━━━━━━━━━━━━━━━━",
    f"<blockquote><i>👤 <b>User:</b> <code>{name}</code></i></blockquote>",
    f"<blockquote><i>🚩 <b>Country:</b> {country_display}</i></blockquote>",
    f"<blockquote><i>💳 <b>Plan:</b> <code>{plan}</code></i></blockquote>",
    f"<blockquote><i>💰 <b>Price:</b> <code>{price}</code></i></blockquote>",
    f"<blockquote><i>📅 <b>Created:</b> {member_since}</i></blockquote>",
    f"<blockquote><i>⏳ <b>Expiry:</b> {next_billing}</i></blockquote>",
    f"<blockquote><i>💳 <b>Method:</b> {payment} {card_display}</i></blockquote>",
    f"<blockquote><i>🎬 <b>Quality:</b> <code>{quality}</code></i></blockquote>",
    f"<blockquote><i>📱 <b>Screens:</b> {streams}</i></blockquote>",
    f"<blockquote><i>👥 <b>Profiles:</b> {profiles}</i></blockquote>",
    f"<blockquote><i>🟢 <b>Status:</b> {active_status}</i></blockquote>",
    "━━━━━━━━━━━━━━━━━━",
    f"👨‍💻 <b>Dev:</b> <a href='https://t.me/murphython'>Murphy</a> | <a href='https://t.me/+00Uzen6uu10zYTZk'>CoمبوZ</a>"
]
